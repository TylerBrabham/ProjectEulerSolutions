"""
This file contains two solutions to problem 81. The first is iterative and fills
out a table diagonally in a standard dp way. The second is the natural recursive 
solution. The second solution is too inefficient to work on the 80 by 80 input
matrix.
"""
